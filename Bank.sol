...
contract Bank {
    ...
    // 沒 payable 會有 error, 因為 selfdestruct 要求是 payable address.
    ...
    function buy(uint256 coinValue) public {
        ...
        require(coinBalance[msg.sender] >= value, "your coinBalance is not enough");

        // require msg.sender 的 etherBalance 不小於 value
        require(balance[msg.sender] >= value, "etherbalance is not enough");
    ...
    function transferCoin(address to, uint256 coinValue) public {
        ...
        require(coinBalance[msg.sender] >= value, "your balance is not enough");
